...
public class CustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public CustomAuthenticationFilter(AuthenticationManager authenticationManager, IClientRepository clientRepository){
...
//        response.setHeader("access_token",access_token);
        ...
        if(client.getFirstName() != null){
            tokens.put("firstName",client.getFirstName());
        }

        if(client.getLastName() != null){
            tokens.put("lastName",client.getLastName());
        }

        if(client.getBirthDay() != null){
            tokens.put("birthDay",client.getBirthDay().toString());
        }

        if(client.getPhoneNumber() != null){
            tokens.put("phoneNumber",client.getPhoneNumber());
        }
        if(client.getAccountType() != null){
            tokens.put("accountType",client.getAccountType().toString());
        }
